...
void	sort_five_el(t_list	**stack_a, t_list	**stack_b)
{
	...
	{
		if (els.b < els.a && els.a < els.c && els.c < els.d && els.d < els.e)
			sa(stack_a, 0);
		else if (els.b < els.c && els.c < els.d && els.d < els.e && els.e < els.a)
			ra(stack_a, 0);
		else if (els.e < els.a && els.a < els.b && els.b < els.c && els.c < els.d)
			rra(stack_a, 0);
		else
		{
